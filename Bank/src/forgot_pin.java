...
public class forgot_pin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/4x3.png"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(nick.getText().toUpperCase().equals(Bank_db.nick_name[login.ind])&& new_p.getText().equals(Bank_db.u_p[login.ind])){
             JOptionPane.showMessageDialog(null,"New Pin should be different from old one !");
             return; }
        if(nick.getText().toUpperCase().equals(Bank_db.nick_name[login.ind])&& new_p.getText()!=(Bank_db.u_p[login.ind])){
             String p=new_p.getText();
             Bank_db.change_pin(login.ind, p);
              JOptionPane.showMessageDialog(null,"Pin successfully changed !");
              setVisible(false);
             return; }
        if(!(nick.getText().toUpperCase().equals(Bank_db.nick_name[login.ind]))){
